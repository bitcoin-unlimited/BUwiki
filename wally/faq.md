...
You can set up multiple accounts by touching the green "**+**" symbol to the right of the Account Balances line on Wally's home page. The **New Account** page will be displayed. Enter an account name of your choice. Account names can be from 1 to 8 characters (letters, numbers, or symbols) long. Next, select the type of cryptocurrency from those listed on the pull down menu to the right of the **Blockchain** line. Bitcoin Cash is the default, and the other choices include experimental and test blockchains. If you would like to require a PIN in order to access this new account, type in a numeric PIN on the line provided.

**Important note!**  You will need each account's PIN to access the funds in each account, so remember the PINS forever and also write them down and save them somewhere safe. Secondly, after setting up each account, be sure to go to Wally's settings page and write down the Account Recovery Secret Phrase for each account.  (See SETTINGS below.) 
...
**(Note to software engineer: The bitcoin.com site with the map is https://map.bitcoin.com/.  A list of merchants that accept bitcoin cash is at https://acceptbitcoin.cash/.  A list of casinos that accept bitcoin cash is at https://wizardofodds.com/banking/cryptocurrency/Bitcoin-Cash/ and another one at https://www.casinonewsdaily.com/casino-deposit-methods/casinos-accepting-bitcoin-cash/.**  
